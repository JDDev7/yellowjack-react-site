        ...
        <motion.div {...appearFromLeft} className="left-side">
          ...
          <div className="blackboard">
            <div className="title-container">
              <h1>
                <span className="span-text-color">Prueba</span> nuestro chuletón
                de 1kg
              </h1>
            </div>
            <div className="hero-text-container">
              <p>
                La octava maravilla de Sandy Shores. Un plato que no podrás
                encontrar en ninguna otra parte de la isla. Hecho al punto que
                te guste, con salsa, especias de la casa y guarnición a
                elección.
              </p>
            </div>
          </div>
